...
module.exports = {
  ...
  menu: process.env.MENU || "", /**  Available @MENU @Schemes 1: Aztec_Md, 2: A17_EX, 3: EX-RADIATION Default ---------- If Not Choose then it Randomely Pic One Of Them Each time **/

  HANDLERS: process.env.PREFIX  || ".",
  BRANCH  : process.env.BRANCH  || "main",
  VERSION : process.env.VERSION || "1.0.1-developement-x",
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ ARLODRAGON 』```", //*『sᴜʙsᴄʀɪʙᴇ • DRAGON』*\n youtube.com/@suhailtechinfo0"),
